 ...
 * @description Simple script that opens an overlay / modal with some content form either a selector or an URL. To have more close-buttons inside the overlay, use the css class js-novi-overlay-close
...
novicell.overlay =
    ...
    new function() {
        ...
        function setupCloseButton() {
            ...
            //find all available close buttons inside the backdrop - also the ones not generated from the script
            var closeButtons = document.querySelectorAll(
                '#js-novi-backdrop .js-novi-overlay-close'
            );
